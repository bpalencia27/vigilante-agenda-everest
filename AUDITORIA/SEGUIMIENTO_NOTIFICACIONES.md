...
| 2026-09-07 | DEPLOY | Menú de interpretación general del uroanálisis (v18.4.5, requerimiento del 07-sep): commit d5b38d7 pusheado; banco final 3491/0 (suite_90 nueva, 24 casos, +6 mutaciones); flaky H5 de suite_89 estabilizado con crypto inyectado. Gist actualizado (gistfile1.txt + copia vigilante_agenda.user.js para instalación en 1 clic) |
| 2026-09-07 | VERIF | **Verificación gist ↔ local (v18.4.5):** userscript limpio en HEAD d5b38d7; 13 anclas cotejadas (v18.4.5 menú uro ×5, v18.4.4 pym_opcional ×3, NT ×5 — incl. M13, z-index sp-toast/tip-pop, --t-nano ×2); node --check OK. Gist comparado contra el local con SHA-256 normalizado (CRLF→LF): DE58C41962C556FE0FB7498DB667914119784FB2E456205FE9477F5C3F1DC39C — gistfile1.txt y vigilante_agenda.user.js AMBOS idénticos (100%); @version servido: 18.4.5. Sin discrepancias: no hizo falta re-subir |
