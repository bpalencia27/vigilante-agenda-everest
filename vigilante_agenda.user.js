 ...
 // ventana real de la página (sandbox de Tampermonkey)
  ...
  function buildOverlay() {
    ...
    style.textContent = `
      ...
      /* Clases de utilidad agregadas para migrar estilos en línea de modales */
      #vgl-root #vgl-labs-modal .vgl-agm-card-760, #vgl-root #vgl-agendar-modal .vgl-agm-card-760, #vgl-root #vgl-ordenar-modal .vgl-agm-card-760, .vgl-agm-card-760 { max-width: 760px; }
      #vgl-root #vgl-labs-modal .vgl-agm-card-720, #vgl-root #vgl-agendar-modal .vgl-agm-card-720, #vgl-root #vgl-ordenar-modal .vgl-agm-card-720, .vgl-agm-card-720 { max-width: 720px; }
      #vgl-root #vgl-labs-modal .vgl-agm-card-680, #vgl-root #vgl-agendar-modal .vgl-agm-card-680, #vgl-root #vgl-ordenar-modal .vgl-agm-card-680, .vgl-agm-card-680 { max-width: 680px; }
      #vgl-root #vgl-labs-modal .vgl-agm-card-520, #vgl-root #vgl-agendar-modal .vgl-agm-card-520, #vgl-root #vgl-ordenar-modal .vgl-agm-card-520, .vgl-agm-card-520 { max-width: 520px; }
      .vgl-min-w-0 { min-width: 0; }
      .vgl-mb-14 { margin-bottom: 14px; }
      .vgl-max-h-420-scroll { max-height: 420px; overflow-y: auto; display: block; }
      .vgl-flex-wrap-gap-6 { flex-wrap: wrap; gap: 6px; }
      .vgl-mt-8-gap-5-wrap { margin-top: 8px; gap: 5px; flex-wrap: wrap; }
      .vgl-mt-6 { margin-top: 6px; }
      .vgl-d-none-mb-10 { display: none; margin-bottom: 10px; }
      .vgl-input-tel { width: auto; min-width: 150px; flex: 1; padding: 7px 11px; font-size: 13px; }
      .vgl-m-2-0-6-gap-4-wrap { margin: 2px 0 6px; gap: 4px; flex-wrap: wrap; }
      .vgl-input-sel { width: auto; flex: 1; padding: 7px 9px; font-size: var(--t-micro, 12px); }
      .vgl-gap-5-wrap { gap: 5px; flex-wrap: wrap; }
      .vgl-mt-10 { margin-top: 10px; }
      .vgl-mt-14 { margin-top: 14px; }
      .vgl-flex-1-min-w-180 { flex: 1; min-width: 180px; }
      .vgl-d-none { display: none; }
      .vgl-mt-0 { margin-top: 0; }
      .vgl-gap-10 { gap: 10px; }
      .vgl-mt-9-gap-10 { margin-top: 9px; gap: 10px; }
      .vgl-mt-7-gap-10 { margin-top: 7px; gap: 10px; }
    `;
  ...
  async function openLaboratoriosModal(apt) {
    ...
    modal.innerHTML = `
      <div class="vgl-agm-card vgl-agm-card-760">
        <div class="vgl-agm-head">
          <div class="vgl-min-w-0">
        ...
        <div class="vgl-agm-sec vgl-labs-srcbar vgl-mb-14">
        ...
        <div class="vgl-agm-sec">
          ...
          <div id="vgl-labs-content" class="vgl-agm-slots vgl-max-h-420-scroll">
  ...
  function openAgendamientoModal(apt) {
    ...
    modal.innerHTML = `
      <div class="vgl-agm-card vgl-agm-card-720">
        <div class="vgl-agm-head">
          <div class="vgl-min-w-0">
        ...
        <div class="vgl-agm-grid">
          <div class="vgl-agm-cell vgl-agm-c5">
            ...
            <div id="vgl-esp-presets" class="vgl-agm-presets vgl-flex-wrap-gap-6">
          ...
          <div class="vgl-agm-cell vgl-agm-c7">
            ...
            <div id="vgl-day-chips" class="vgl-agm-presets vgl-mt-8-gap-5-wrap"></div>
            <div id="vgl-agm-date-info" class="vgl-agm-dinfo vgl-mt-6">Calculando fecha deseada...</div>
          </div>
          ...
          <div class="vgl-agm-cell vgl-agm-c12 vgl-agm-cell-flat">
            ...
            <div id="vgl-agm-prog-box" class="vgl-d-none-mb-10">
          ...
          <div id="vgl-agm-sms-box" class="vgl-agm-cell vgl-agm-c6 vgl-agm-cell-sms">
            ...
            <div class="vgl-agm-fieldrow">
              ...
              <input type="tel" id="vgl-agm-sms-tel" class="vgl-agm-input vgl-input-tel" placeholder="cargando…">
          ...
          <div class="vgl-lab-box vgl-agm-cell vgl-agm-c6 vgl-agm-cell-lab">
            ...
            <div id="vgl-lab-day-chips" class="vgl-agm-presets vgl-m-2-0-6-gap-4-wrap"></div>
            <div class="vgl-agm-fieldrow">
              <label for="vgl-agm-lab-time-sel">Hora del Laboratorio:</label>
              <select id="vgl-agm-lab-time-sel" class="vgl-agm-input vgl-input-sel">
  ...
  async function openLabSoloModal(apt) {
    ...
    modal.innerHTML = `
      <div class="vgl-agm-card vgl-agm-card-520">
        <div class="vgl-agm-head">
          <div class="vgl-min-w-0">
        ...
        <div class="vgl-agm-sec">
          ...
          <div id="vgl-lab-day-chips" class="vgl-agm-presets vgl-gap-5-wrap"></div>
          <div class="vgl-agm-fieldrow vgl-mt-10">
            <label for="vgl-agm-lab-time-sel">Hora del Laboratorio:</label>
            <select id="vgl-agm-lab-time-sel" class="vgl-agm-input vgl-input-sel">
              <option value="">⏳ Consultando disponibilidades en AppCita...</option>
            </select>
  ...
  async function openOrdenamientoModal(apt) {
    ...
    modal.innerHTML = `
      <div class="vgl-agm-card vgl-agm-card-680">
        <div class="vgl-agm-head">
          <div class="vgl-min-w-0">
    ...
    confirmBtn.addEventListener("click", async () => {
      ...
      if (creadasCount > 0 && fallidasCount === 0) {
        ...
        if (vivo()) {
          ...
          mailBox.innerHTML = `
            <label class="vgl-agm-lbl vgl-mt-14">📧 Enviar la(s) orden(es) al correo del paciente (opcional)</label>
            <div class="vgl-agm-fieldrow">
              <input type="email" id="vgl-ord-mail-input" class="vgl-agm-input vgl-flex-1-min-w-180" placeholder="correo@ejemplo.com">
...
<!-- v12.0.0: «Actualizar lista de prevención» y «Sincronizar almacenamiento» se movieron
  ...
  function renderStats(list) {
    ...
    statsSig = sig;
    el.stats.innerHTML =
      `<div class="vgl-sb-lbl vgl-mt-0">Estado</div>` +
    ...
    for (const a of vista) {
      ...
      card.innerHTML = `
        <div class="vgl-card-top" style="--tc:var(--c-${COLORS[a.color] ? a.color.toLowerCase() : "azul"},${col});--trgb:var(--rgb-${COLORS[a.color] ? a.color.toLowerCase() : "azul"});gap:10px">
          <div class="vgl-card-time-wrap vgl-gap-10">
        ...
        <div class="vgl-card-mid vgl-mt-9-gap-10">
        ...
        <div class="vgl-card-btm vgl-mt-7-gap-10">
          ${pyms}
          ${actions}
        </div>`;
      card.__vglKey = a.key;
