...
- [J1a] **HbA1c no se juzga (Oculto temporalmente):** Actualmente `esDM2` se ha retirado de `_evaluarAccionesRenales` al no haber consenso sobre de dónde extraer exactamente esta información de los antecedentes. Esta es una omisión deliberada y segura para evitar ordenar la prueba a pacientes no diabéticos. A la espera de directrices clínicas para proveer la fuente.
