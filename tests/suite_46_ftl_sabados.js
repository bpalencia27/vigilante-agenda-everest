...
module.exports = {
  ...
  pruebas(t, api) {
    ...
    t.caso("el control cae en sábado SOLO si a ese médico le toca ese sábado", () => {
      t.falso(api.mtrDiaValidoParaControlConSabado("2026-08-08", "1-3"), "2º sábado, grupo 1-3: no");
      t.cierto(api.mtrDiaValidoParaControlConSabado("2026-08-08", "2-4"), "2º sábado, grupo 2-4: sí");
      t.falso(api.mtrDiaValidoParaControlConSabado("2026-08-08", null), "sin grupo conocido no se propone sábado");
