  ...
  async pruebas(t, api, env, cargar) {
    ...
    t.caso("checkVersionMinimum: versión vieja => marca de sesión, abre la ventana de refresco de la base y respeta el candado 5 min", () => {
      ...
      const c = cargar({
        ...
        gmxhr: (o) => {
          ...
          // propio bloqueo (verlock) también va al worker (workers.dev, v18.14.0) y NO
          // debe servirse aquí (contestarle "éxito" vaciaría la cola que este banco quiere leer).
          if (o.method !== "GET" || !String(o.url).includes("workers.dev")) return;
          llamadas.push(o.url);
    ...
    t.caso("checkVersionMinimum: al día no hace nada, y con historia clínica abierta NUNCA recarga", () => {
      ...
      const c = cargar({
        silencioso: true,
        gmxhr: (o) => {
          if (!String(o.url).includes("workers.dev")) return;
          llamadas.push(o.url);
    ...
    // Este caso la caza: el conteo de handles debe subir en 17 (los once del push
