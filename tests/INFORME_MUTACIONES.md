...
| suite_05 | Quitar async de pruebas y await de casoAsync | Sí | runner blindado con Promise.all() atrapa el test huérfano con código 1 y fallos (la comprobación en suite_26 la atrapa también, pero el bucle de pendientes se liquida adecuadamente) - restaurado |
