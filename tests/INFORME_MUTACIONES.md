...
| `suite_25_cascada_css.js` | Regla E - color con selector de PANEL fuera de #vgl-root lleva !important | `vigilante_agenda.user.js` | `#vgl-labsv-modal .vgl-prueba{color:var(--c-rojo)}` | Atrapado (no tiene !important) y revertido. |
