...
| `suite_02_tiempo_fechas.js` | Horas, fechas hábiles, bitácora | ⬜ pendiente |
| `suite_03_excel_pym.js` | Lector de Excel, caché, SharePoint | ⬜ pendiente |
| `suite_04_agenda_alertas.js` | Colores, extemporáneas, notificaciones | ⬜ pendiente |
...
`date_logic.test.js` es el test antiguo. Funciona (8 comprobaciones) pero **copia** las funciones en vez de importarlas, así que puede quedar desfasado sin avisar. Conviene reescribirlo dentro del nuevo banco y borrarlo.
