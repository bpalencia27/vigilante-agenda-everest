...
| `suite_05_api_everest.js` | Llamadas a Everest, laboratorios, órdenes | ✅ 10 comprobaciones |
...
## Suites 07, 08 y 09
Se han implementado con un simulador de ZIP y DOM (Suite 07, 08) y se ha mejorado la Suite 02 (equivalente a 09) probando parsing de fechas y calculos regresivos de turnos.
