...
module.exports = {
  ...
  async pruebas(t, api, env, cargar) {
    ...
    t.caso("mtrAbrirPanelRedaccion: las filas de casillas y 'otros' y 'Mi estilo' llevan su burbuja explicando qué hace cada uno", () => {
      const doc = env.doc;
      ...
      t.cierto(nBurbujas >= 3, "una burbuja por fila de modos y otra para 'Mi estilo' (encontradas: " + nBurbujas + ")");
      ...
      t.cierto(/Guardar mi estilo/.test(html), "la burbuja de 'Mi estilo' remite al botón que guarda los ejemplos");
